...
import '../../widgets/gesture_detector_logo.dart';
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget _buildMainScreen(
      BuildContext context, WidgetRef ref, Map<String, dynamic>? config) {
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(int.parse((config?['primary_color'] ?? '#E62144')
                  .replaceFirst('#', '0xFF'))),
              Color(int.parse((config?['secondary_color'] ?? '#8B1538')
                  .replaceFirst('#', '0xFF'))),
            ],
          ),
        ),
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              '👆 3 toques para Login • Mantén presionado 3s para Modo Técnico',
